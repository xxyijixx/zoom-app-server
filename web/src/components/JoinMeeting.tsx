      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8 relative">
          ...
          <button
            ...
            className="absolute top-4 right-4 text-green-600 hover:text-green-700 text-sm font-medium transition-colors duration-200 flex items-center space-x-1"
          >
            <span>创建会议</span>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-center text-gray-800 mb-8">加入 Zoom 会议</h2>
